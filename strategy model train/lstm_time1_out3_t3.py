...
def create_model(look_back, out_dim):
    ...
    model.add(layers.Flatten(input_shape=(look_back, in_dim)))
    model.add(layers.Dense(64))
    model.add(layers.Dense(out_dim))
    optimizer = tf.keras.optimizers.Adam(learning_rate=0.6,beta_1=0.999)
